...
def get_ptb_data():
    ...
    if not os.path.exists('trees'):
        ...
        exit()
    elif not os.path.exists('trees/train.txt'):
        print("train.txt is not in trees/train.txt")
        print("Please download the data from http://nlp.stanford.edu/sentiment/")
        exit()
    elif not os.path.exists('trees/test.txt'):
        print("test.txt is not in trees/test.txt")
        print("Please download the data from http://nlp.stanford.edu/sentiment/")
        exit()
